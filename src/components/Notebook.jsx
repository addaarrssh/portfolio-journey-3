...
// Spotlight disabled so all notebook content remains fully bright and readable
const spotlight = (x, y) => "none";
        ...
        <div className="relative z-10 w-full h-full" style={{ perspective: "1800px" }}>
          ...
          <div data-nb="spread-wrap" className="absolute top-0 left-0 origin-top-left will-change-transform">
            ...
            >
              ...
              {/* Spotlight overlay container (disabled for full content visibility) */}
              <div
                data-nb="overlay"
